...
Заметим, что некоторые нетерминалы мы можем описать в качестве регулярных выражений, в составе которых также могут присутствовать другие нетерминалы(что-то вроде RegEx)
$$\begin{aligned}
B &= aba^* \\
T &= b^*a ?(S) \\
