...
>Но так как меньшее поддерево(обозначим как $T_2$) соответсвует также состоянию $q_i$, то большее поддерево(обозначим за $T_1$) можно заменить на $T_2$ без потери принадлежности языку. Но при такой замене, мы получим несбалансированные поддеревья слева и справа от $S_2$. Таким образом получаем противоречие. Следовательно, классов эквивалентности бесконечное число.
>
